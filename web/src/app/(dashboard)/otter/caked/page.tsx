      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-6">
        <header className="flex flex-col gap-1">
          ...
          <p className="text-sm text-ink-dim max-w-2xl">
            Post a Caked Up card directly to a Discord channel. The contact,
            event, and pricing cards are the same Components V2 layouts the{' '}
            <code>/caked</code> slash command renders — single source of
            truth on the bot side. Announcements are free-form text wrapped
            in the Caked brand container.
          </p>
        </header>
